// WebSocket control-channel message contract for room speaker/listener connections,
// shared between backEnd and frontEnd so both sides change these shapes in exactly one place.
